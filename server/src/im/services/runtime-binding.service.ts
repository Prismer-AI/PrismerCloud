/**
 * Workspace runtime binding state helpers.
 *
 * We keep the first implementation lightweight by storing forgotten daemon IDs
 * inside `IMWorkspace.metadata` instead of introducing a new table. This is
 * enough to keep workspace views stable while we separate K8s runtime removal
 * from local daemon workspace unbinding.
 */
