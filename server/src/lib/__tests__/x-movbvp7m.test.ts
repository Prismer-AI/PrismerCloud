...
import { Xmovbvp7m } from '../x-movbvp7m';
...
describe('X-movbvp7m', () => {
  let xmovbvp7m: Xmovbvp7m;

  beforeEach(() => {
    xmovbvp7m = new Xmovbvp7m({
      timeoutMs: 5000,
      retries: 1,
  ...
  describe('基本功能', () => {
    it('应该正确初始化', () => {
      expect(xmovbvp7m).toBeDefined();
    });

    it('应该使用默认配置', () => {
      const instance = new Xmovbvp7m();
      expect(instance).toBeDefined();
    });

    it('应该接受自定义配置', () => {
      const instance = new Xmovbvp7m({ timeoutMs: 10000 });
      expect(instance).toBeDefined();
    });
  });
  ...
  describe('环境检查', () => {
    it('应该成功检查环境', async () => {
      const result = await xmovbvp7m.checkEnvironment();
  ...
  describe('数据库检查', () => {
    it('应该成功检查数据库连接', async () => {
      const result = await xmovbvp7m.checkDatabaseConnectivity();
  ...
  describe('API 检查', () => {
    it('应该成功检查 API 端点', async () => {
      const result = await xmovbvp7m.checkApiEndpoints();
  ...
  describe('内存检查', () => {
    it('应该成功检查内存使用', async () => {
      const result = await xmovbvp7m.checkMemoryUsage();
  ...
  describe('磁盘检查', () => {
    it('应该成功检查磁盘空间', async () => {
      const result = await xmovbvp7m.checkDiskSpace();
  ...
  describe('快速健康检查', () => {
    it('应该返回 M4OK-movbvp7m 标记', async () => {
      const result = await xmovbvp7m.quickHealthCheck();

      expect(result.success).toBe(true);
      expect(result.message).toBe('M4OK-movbvp7m');
  ...
  describe('完整 Smoke Test', () => {
    it('应该运行完整的 smoke test 套件', async () => {
      const result = await xmovbvp7m.runSmokeTest();
 ...
 * 集成测试
 */
describe('X-movbvp7m 集成测试', () => {
  it('应该支持多次连续调用', async () => {
    const xmovbvp7m = new Xmovbvp7m();

    const result1 = await xmovbvp7m.quickHealthCheck();
    const result2 = await xmovbvp7m.quickHealthCheck();
    const result3 = await xmovbvp7m.quickHealthCheck();
