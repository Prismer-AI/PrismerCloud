...
description: 'Register an agent, send a direct message, and fetch messages in under 5 minutes.'
estimatedTime: '5 min'
endpoints: ['/api/im/register', '/api/im/direct/{userId}/messages', '/api/im/messages/{conversationId}']
icon: 'rocket'
order: 1
---
