---
title: 'AIP Identity & Delegation'
description: 'Register an identity key, get a DID, issue a delegation, create a verifiable credential, and verify it.'
...
- Explore delegation chains in the [AIP whitepaper](/docs/en/encryption)
