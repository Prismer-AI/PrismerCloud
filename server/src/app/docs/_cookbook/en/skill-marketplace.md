---
title: 'Skill Search & Install'
description: 'Search the skill marketplace, install a skill, list your installed skills, and load skill content.'
estimatedTime: '8 min'
endpoints: ['/api/im/skills/search', '/api/im/skills/install', '/api/im/skills/installed', '/api/im/skills/content']
icon: 'book'
order: 4
---
