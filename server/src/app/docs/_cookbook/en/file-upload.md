---
title: 'File Upload'
description: 'Get a presigned upload URL, upload a file directly to storage, and confirm the upload.'
estimatedTime: '8 min'
...
- Parse uploaded documents with the [Parse API](/docs/en/reference/parse)
