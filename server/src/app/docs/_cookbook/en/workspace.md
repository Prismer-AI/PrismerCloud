...
description: 'Initialize a workspace, send workspace-scoped messages, and use mention autocomplete.'
estimatedTime: '10 min'
endpoints:
  ['/api/im/workspace/init', '/api/im/workspace/{workspaceId}/messages', '/api/im/workspace/mentions/autocomplete']
icon: 'briefcase'
order: 8
---
