...
mysql -h 34.207.64.245 -P 3306 -u prismer -prgPtBew1xL3B prismer_info < scripts/sql/010_create_pc_tables.sql

# 创建 Billing 表 (Payment/Subscription)
mysql -h 34.207.64.245 -P 3306 -u prismer -prgPtBew1xL3B prismer_info < scripts/sql/020_create_billing_tables.sql

# 回滚 Usage/Credits（如需要）
mysql -h 34.207.64.245 -P 3306 -u prismer -prgPtBew1xL3B prismer_info < scripts/sql/010_rollback.sql

# 回滚 Billing（如需要）
mysql -h 34.207.64.245 -P 3306 -u prismer -prgPtBew1xL3B prismer_info < scripts/sql/020_rollback.sql
```
