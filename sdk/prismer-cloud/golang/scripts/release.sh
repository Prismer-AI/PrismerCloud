...
echo "   go get github.com/Prismer-AI/PrismerCloud/sdk/prismer-cloud/golang@sdk/golang/$VERSION"
echo ""
echo "Note: Make sure the GitHub repo is public and the module path"
echo "in go.mod matches: github.com/Prismer-AI/PrismerCloud/sdk/prismer-cloud/golang"
