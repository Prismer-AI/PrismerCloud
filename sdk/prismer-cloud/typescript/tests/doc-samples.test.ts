...
describe('Doc Samples: Context API', () => {
  ...
  it('prismer.context.load — single URL', async () => {
    // --- sample start ---
  ...
  it('prismer.context.load — batch URLs', async () => {
    // --- sample start ---
    const client = new PrismerClient({ apiKey: 'sk-prismer-xxx' });
  ...
  it('prismer.context.load — search query', async () => {
    // --- sample start ---
    const client = new PrismerClient({ apiKey: 'sk-prismer-xxx' });
...
describe('Doc Samples: Parse API', () => {
  ...
  it('prismer.parse.document — PDF with fast mode', async () => {
    // --- sample start ---
    const client = new PrismerClient({ apiKey: 'sk-prismer-xxx' });
  ...
  it('prismer.parse.document — with options', async () => {
    // --- sample start ---
    const client = new PrismerClient({ apiKey: 'sk-prismer-xxx' });
