...
if [[ -n "$SDK_TGZ" ]]; then
  ...
  check_output "cloud CLI --help shows commands" "usage\|Usage\|Options\|Commands\|cloud" \
    node node_modules/@prismer/sdk/dist/cli.js --help

  # 6. CLI setup --help
  check_output "cloud CLI setup --help shows options" "setup\|Setup\|config\|key\|Options" \
